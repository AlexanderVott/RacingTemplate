    ...
    public static class GizmosExtra {
        ...
        public static void DrawWireCylinder(Vector3 pos, Vector3 dir, float radius, float height) {
            ...
            for (float i = 0; i < 6.28f; i += 0.1f) {
                ...
                circle0Point1 = pos + quat * new Vector3(Mathf.Sin(i + 0.1f) * radius, Mathf.Cos(i + 0.1f) * radius,
                                    halfHeight);
                ...
                circle1Point1 = pos + quat * new Vector3(Mathf.Sin(i + 0.1f) * radius, Mathf.Cos(i + 0.1f) * radius,
                                    -halfHeight);
