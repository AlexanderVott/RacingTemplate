...
namespace RVP {
    ...
    public class DetachablePart : MonoBehaviour {
        ...
        [System.NonSerialized] public HingeJoint hinge;
        ...
        [System.NonSerialized] public Vector3 displacedAnchor;
        ...
        private void Update() {
            if (hinge) // Destory hinge if displaced too far from original position
            ...
            if (!detached) {
                ...
                if (parentBody) {
                    ...
                    if (makeJoint && joints.Length > 0) {
                        var chosenJoint = joints[Random.Range(0, joints.Length)];
        ...
        private void OnDrawGizmosSelected() {
            ...
            if (looseForce >= 0 && joints.Length > 0) {
                ...
                foreach (var curJoint in joints) {
                    Gizmos.DrawRay(tr.TransformPoint(curJoint.hingeAnchor),
                        tr.TransformDirection(curJoint.hingeAxis).normalized * 0.2f);
