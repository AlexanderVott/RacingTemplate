...
namespace RVP {
    ...
    public class MobileInput : MonoBehaviour {
        ...
        [System.NonSerialized] public float accel;
        [System.NonSerialized] public float brake;
        [System.NonSerialized] public float steer;
        [System.NonSerialized] public float ebrake;
        [System.NonSerialized] public bool boost;

        // Set screen orientation
        private void Start() {
            Screen.autorotateToPortrait =
                screenRot == ScreenOrientation.Portrait || screenRot == ScreenOrientation.AutoRotation;
