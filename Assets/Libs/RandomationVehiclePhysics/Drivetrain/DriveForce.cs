...
namespace RVP {
    ...
    public class DriveForce : MonoBehaviour {
        [System.NonSerialized] public float rpm;
        [System.NonSerialized] public float torque;
        [System.NonSerialized] public AnimationCurve curve; // Torque curve
        [System.NonSerialized] public float feedbackRPM;    // RPM sent back through the drivetrain
